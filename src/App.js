...
function App() {
  ...
  const [product, setProduct] = useState([
    ...
    {
      url: 'https://images-cdn.ubuy.co.in/63747419e1e7a809f243ece3-doldoa-big-teddy-bear-stuffed-animals.jpg',
      name: 'Teddy Bear',
      category: 'Toy',
      seller: 'ABS Ltd',
      price: 1000
    ...
    {
      url: 'https://boip.in/27067-large_default/apple-iphone-7-32gb-certified-refurbished-very-good.jpg',
      name: 'Iphone',
      category: 'Mobile',
      seller: 'Apple Ltd',
      price: 30000
    ...
    {
      url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRU-i5g71n_c6shhuMi9Ql3K-Up2ffU7zDPJw&usqp=CAU',
      name: 'Cup red Color',
      category: 'Cup',
      seller: 'ABS Ltd',
      price: 100
